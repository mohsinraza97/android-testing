...
class DefaultTasksRepositoryTest {
    ...
    fun setup() {
        ...
        repository = DefaultTasksRepository(remoteDataSource, localDataSource, Dispatchers.Main)
    }

    @Test
    fun getTasks_requestAllTasksFromRemoteDataSource() = testDispatcherRule.runBlockingTest {
